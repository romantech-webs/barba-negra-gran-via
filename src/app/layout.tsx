  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="barba-negra-gran-via";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="BARBA NEGRA GRAN VIA"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="barba-negra-gran-via"
          data-primary-color="#D4A574"
          defer
        ></script>
      </head>
